...
static const uint16_t palette_custom[16] = {
    RGB565_BLACK, RGB565_NIGHT_SKY, RGB565_GREEN_BRIGHT, RGB565_SNIPER_DARK_GREY,
    RGB565_DUCK_ORANGE, RGB565_TEAL, RGB565_DUCK_GREEN, RGB565_SKY_BLUE,
    RGB565_BEIGE , RGB565_SKY_BLUE, RGB565_CYAN, RGB565_RED,
    RGB565_PINK_BRIGHT, RGB565_CYAN_BRIGHT, RGB565_SNIPER_GREY, RGB565_WHITE
};
